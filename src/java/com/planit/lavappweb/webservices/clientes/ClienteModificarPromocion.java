...
public class ClienteModificarPromocion {
     ...
     */
    public <T> T modificarPromocion(Class<T> responseType, String idPromocion, String fechaInicio, String fechaFinal, String porcentaje, String horaInicio, String horaFinal, String nombre) throws ClientErrorException {
        String[] queryParamNames = new String[]{"idPromocion", "fechaInicio", "fechaFinal", "porcentaje", "horaInicio", "horaFinal", "nombre"};
        String[] queryParamValues = new String[]{idPromocion, fechaInicio, fechaFinal, porcentaje, horaInicio, horaFinal, nombre};
        ;
