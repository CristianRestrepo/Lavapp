 ...
 * [eliminarAsociacionZona]<br>
 * USAGE:
 * <pre>
 *        ClienteEliminarAsociacionZona client = new ClienteEliminarAsociacionZona();
 ...
 */
public class ClienteEliminarAsociacionZona {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = ruta.consultarRuta();

    public ClienteEliminarAsociacionZona() {
        client = ResteasyClientBuilder.newBuilder().build();
        webTarget = client.target(BASE_URI).path("eliminarAsociacionZona");
    }
     ...
     */
    public <T> T eliminarAsociacionZona(Class<T> responseType, String idUsuario, String idZona) throws ClientErrorException {
