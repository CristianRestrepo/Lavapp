 ...
 * USAGE:
 * <pre>
 *        ClienteRegistrarJornada client = new ClienteRegistrarJornada();
 ...
 */
public class ClienteRegistrarJornada {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8084/LavappService/webresources/";

    public ClienteRegistrarJornada() {
        client = ResteasyClientBuilder.newBuilder().build();
        webTarget = client.target(BASE_URI).path("registrarJornada");
    }
     ...
     */
    public <T> T registrarJornada(Class<T> responseType, String nombre) throws ClientErrorException {
