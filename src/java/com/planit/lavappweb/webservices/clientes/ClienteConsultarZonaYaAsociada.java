 ...
 * [consultarZonaYaAsociada]<br>
 * USAGE:
 * <pre>
 *        ClienteConsultarZonaYaAsociada client = new ClienteConsultarZonaYaAsociada();
 ...
 */
public class ClienteConsultarZonaYaAsociada {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = ruta.consultarRuta();

    public ClienteConsultarZonaYaAsociada() {
        client = ResteasyClientBuilder.newBuilder().build();
        webTarget = client.target(BASE_URI).path("consultarZonaYaAsociada");
    }
     ...
     */
    public <T> T consultarZonaYaAsociada(Class<T> responseType, String idUsuario, String idZona) throws ClientErrorException {
