...
public class ClienteEditarSubProducto {
     ...
     */
    public <T> T modificarSubProductos(Class<T> responseType, String idSubProductos, String nombre, String desc, String idProducto) throws ClientErrorException {
        String[] queryParamNames = new String[]{"idSubProductos", "nombre", "desc", "idProducto"};
        String[] queryParamValues = new String[]{idSubProductos, nombre, desc, idProducto};        
